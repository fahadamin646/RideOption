...
<html lang="en">
  <head>
    ...
    <script src="Backend/Dashboard.js?s=1"></script>
      ...
      >
        <div class="container-fluid py-1 px-2">
          <nav aria-label="breadcrumb">
            <h5 class="font-weight-bold mb-0">Manage Users</h5>
          </nav>
          <div
...
<!-- The Modal -->
    ...
    <script>
      ...
      function fetch() {
        $.ajax({
          url: "../Backend/DashboardController.php?table=users",
          method: "get",
          type: "get",
