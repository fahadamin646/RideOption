<aside
  class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-white fixed-start"
  id="sidenav-main"
>
  <div class="sidenav-header">
    ...
    <a
      ...
      href=" https://demos.creative-tim.com/corporate-ui-dashboard/pages/dashboard.php
       "
      target="_blank"
    >
      <span class="font-weight-bold text-lg">Ride Options</span>
    </a>
  </div>
  <div class="collapse navbar-collapse px-4 w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link active dashboard" href="../pages/dashboard.php">
          <div
      ...
      <li class="nav-item">
        <a class="nav-link customer" href="user-management.php">
          <div
            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center"
          >
            <svg
      ...
      <li class="nav-item">
        <a class="nav-link payment" href="Payments.php">
          <div
            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center"
          >
            <svg
      ...
      <li class="nav-item">
        <a class="nav-link driver" href="drivers.php">
          <div
            class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center"
          >
            <svg
      ...
      <li class="nav-item mt-2">
        <div class="d-flex align-items-center nav-link">
          ...
          <span class="font-weight-normal text-md ms-2">Accounts</span>
        </div>
      </li>
      ...
      <li class="nav-item border-start my-0 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2" onclick="logout()">
